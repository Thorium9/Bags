...
public class Bags{
  ...
  */
   ...
   String moneyYouHave_string1 = JOptionPane.showInputDialog ("How much money you spending? only use dollars ");
  ...
  String apples_string1 = JOptionPane.showInputDialog ("Let's " +
         ...
         "would like.");
  int applesint = obj.StringDecInt(apples_string1);
  String oranges_string1 = JOptionPane.showInputDialog ("Let's " +
         "fill the box.\nPlease enter how many whole oranges you " +
         "would like.");
  int orangesint = obj.StringDecInt(oranges_string1);
  String chocolate_string1 = JOptionPane.showInputDialog ("Let's " +
         "fill the box.\nPlease enter how many boxes of chocolates you " +
         "would like.");
  int chocolateint = obj.StringDecInt(chocolate_string1);
